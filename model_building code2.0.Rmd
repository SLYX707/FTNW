...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_irna3$Yor))-as.vector(24*prediciton_cla_glm_irna3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_irna3$Yor)), as.vector(24*prediciton_cla_glm_irna3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_irna5$Yor))-as.vector(24*prediciton_cla_glm_irna5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_irna5$Yor)), as.vector(24*prediciton_cla_glm_irna5$p1)))))

```
```{r}
# table6
mean_ycount_on_training <- mean(Model_matrix_irna$Yor)
# pred_ycount <- pmax( round( (prob_1*24) - mean(prob_1*24) + mean(ycount_on_training)), 1)
prediciton_cla_glm_irna6 <- prediciton_cla_glm_irna5
prediciton_cla_glm_irna6$pred <- pmax( round( (prediciton_cla_glm_irna5$p1*24) - mean(prediciton_cla_glm_irna5$p1*24) + mean_ycount_on_training), 1)
...
#5-fold
  for (i in 1:5){
    ...
    test <- data[cvlist[[i]],]
    #Store corresponding count(authenticated)
    aba_cla_dl_irna <- rbind(aba_cla_dl_irna,subset(as.data.frame(test),select =Yor))#It have Yor(the count) because I added, let is compare with the 24*p1. I also checked that site sequence is matched with the predict.
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_irna3$Yor))-as.vector(24*prediciton_cla_dl_irna3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_irna3$Yor)), as.vector(24*prediciton_cla_dl_irna3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_irna5$Yor))-as.vector(24*prediciton_cla_dl_irna5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_irna5$Yor)), as.vector(24*prediciton_cla_dl_irna5$p1)))))

```
```{r}
#table6
prediciton_cla_dl_irna6 <- prediciton_cla_dl_irna5
prediciton_cla_dl_irna6$pred <- pmax( round( (prediciton_cla_dl_irna5$p1*24) - mean(prediciton_cla_dl_irna5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_irna3$Yor))-as.vector(24*prediciton_cla_xgboost_irna3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_irna3$Yor)), as.vector(24*prediciton_cla_xgboost_irna3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_irna5$Yor))-as.vector(24*prediciton_cla_xgboost_irna5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_irna5$Yor)), as.vector(24*prediciton_cla_xgboost_irna5$p1)))))

```
```{r}
#table6
prediciton_cla_xgboost_irna6 <- prediciton_cla_xgboost_irna5
prediciton_cla_xgboost_irna6$pred <- pmax( round( (prediciton_cla_xgboost_irna5$p1*24) - mean(prediciton_cla_xgboost_irna5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_irna3$Yor))-as.vector(24*prediciton_cla_rf_irna3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_irna3$Yor)), as.vector(24*prediciton_cla_rf_irna3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_irna5$Yor))-as.vector(24*prediciton_cla_rf_irna5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_irna5$Yor)), as.vector(24*prediciton_cla_rf_irna5$p1)))))

```
```{r}
#table6
prediciton_cla_rf_irna6 <- prediciton_cla_rf_irna5
prediciton_cla_rf_irna6$pred <- pmax( round( (prediciton_cla_rf_irna5$p1*24) - mean(prediciton_cla_rf_irna5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_irna_whistle3$Yor))-as.vector(24*prediciton_cla_glm_irna_whistle3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_irna_whistle3$Yor)), as.vector(24*prediciton_cla_glm_irna_whistle3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_irna_whistle5$Yor))-as.vector(24*prediciton_cla_glm_irna_whistle5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_irna_whistle5$Yor)), as.vector(24*prediciton_cla_glm_irna_whistle5$p1)))))

```
```{r}
#table6
prediciton_cla_glm_irna_whistle6 <- prediciton_cla_glm_irna_whistle5
prediciton_cla_glm_irna_whistle6$pred <- pmax( round( (prediciton_cla_glm_irna_whistle5$p1*24) - mean(prediciton_cla_glm_irna_whistle5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_irna_whistle3$Yor))-as.vector(24*prediciton_cla_dl_irna_whistle3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_irna_whistle3$Yor)), as.vector(24*prediciton_cla_dl_irna_whistle3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_irna_whistle5$Yor))-as.vector(24*prediciton_cla_dl_irna_whistle5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_irna_whistle5$Yor)), as.vector(24*prediciton_cla_dl_irna_whistle5$p1)))))

```
```{r}
#table6
prediciton_cla_dl_irna_whistle6 <- prediciton_cla_dl_irna_whistle5
prediciton_cla_dl_irna_whistle6$pred <- pmax( round( (prediciton_cla_dl_irna_whistle5$p1*24) - mean(prediciton_cla_dl_irna_whistle5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_irna_whistle3$Yor))-as.vector(24*prediciton_cla_xgboost_irna_whistle3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_irna_whistle3$Yor)), as.vector(24*prediciton_cla_xgboost_irna_whistle3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_irna_whistle5$Yor))-as.vector(24*prediciton_cla_xgboost_irna_whistle5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_irna_whistle5$Yor)), as.vector(24*prediciton_cla_xgboost_irna_whistle5$p1)))))

```
```{r}
#table6
prediciton_cla_xgboost_irna_whistle6 <- prediciton_cla_xgboost_irna_whistle5
prediciton_cla_xgboost_irna_whistle6$pred <- pmax( round( (prediciton_cla_xgboost_irna_whistle6$p1*24) - mean(prediciton_cla_xgboost_irna_whistle5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_irna_whistle3$Yor))-as.vector(24*prediciton_cla_rf_irna_whistle3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_irna_whistle3$Yor)), as.vector(24*prediciton_cla_rf_irna_whistle3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_irna_whistle5$Yor))-as.vector(24*prediciton_cla_rf_irna_whistle5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_irna_whistle5$Yor)), as.vector(24*prediciton_cla_rf_irna_whistle5$p1)))))

```
```{r}
#table6
prediciton_cla_rf_irna_whistle6 <- prediciton_cla_rf_irna_whistle5
prediciton_cla_rf_irna_whistle6$pred <- pmax( round( (prediciton_cla_rf_irna_whistle6$p1*24) - mean(prediciton_cla_rf_irna_whistle5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_all3$Yor))-as.vector(24*prediciton_cla_glm_all3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_all3$Yor)), as.vector(24*prediciton_cla_glm_all3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_all5$Yor))-as.vector(24*prediciton_cla_glm_all5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_all5$Yor)), as.vector(24*prediciton_cla_glm_all5$p1)))))

```
```{r}
#table6
prediciton_cla_glm_all6 <- prediciton_cla_glm_all5
prediciton_cla_glm_all6$pred <- pmax( round( (prediciton_cla_glm_all6$p1*24) - mean(prediciton_cla_glm_all5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_all3$Yor))-as.vector(24*prediciton_cla_dl_all3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_all3$Yor)), as.vector(24*prediciton_cla_dl_all3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_all5$Yor))-as.vector(24*prediciton_cla_dl_all5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_all5$Yor)), as.vector(24*prediciton_cla_dl_all5$p1)))))

```
```{r}
#table6
prediciton_cla_dl_all6 <- prediciton_cla_dl_all5
prediciton_cla_dl_all6$pred <- pmax( round( (prediciton_cla_dl_all6$p1*24) - mean(prediciton_cla_dl_all5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_all3$Yor))-as.vector(24*prediciton_cla_xgboost_all3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_all3$Yor)), as.vector(24*prediciton_cla_xgboost_all3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_all5$Yor))-as.vector(24*prediciton_cla_xgboost_all5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_all5$Yor)), as.vector(24*prediciton_cla_xgboost_all5$p1)))))

```
```{r}
#table6
prediciton_cla_xgboost_all6 <- prediciton_cla_xgboost_all5
prediciton_cla_xgboost_all6$pred <- pmax( round( (prediciton_cla_xgboost_all6$p1*24) - mean(prediciton_cla_xgboost_all5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_all3$Yor))-as.vector(24*prediciton_cla_rf_all3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_all3$Yor)), as.vector(24*prediciton_cla_rf_all3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_all5$Yor))-as.vector(24*prediciton_cla_rf_all5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_all5$Yor)), as.vector(24*prediciton_cla_rf_all5$p1)))))

```
```{r}
#table6
prediciton_cla_rf_all6 <- prediciton_cla_rf_all5
prediciton_cla_rf_all6$pred <- pmax( round( (prediciton_cla_rf_all6$p1*24) - mean(prediciton_cla_rf_all5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_irna_regulators3$Yor))-as.vector(24*prediciton_cla_glm_irna_regulators3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_irna_regulators3$Yor)), as.vector(24*prediciton_cla_glm_irna_regulators3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_glm_irna_regulators5$Yor))-as.vector(24*prediciton_cla_glm_irna_regulators5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_glm_irna_regulators5$Yor)), as.vector(24*prediciton_cla_glm_irna_regulators5$p1)))))
...
prediciton_cla_glm_irna_regulators6$pred <- pmax( round( (prediciton_cla_glm_irna_regulators5$p1*24) - mean(prediciton_cla_glm_irna_regulators5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_irna_regulators3$Yor))-as.vector(24*prediciton_cla_dl_irna_regulators3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_irna_regulators3$Yor)), as.vector(24*prediciton_cla_dl_irna_regulators3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_dl_irna_regulators5$Yor))-as.vector(24*prediciton_cla_dl_irna_regulators5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_dl_irna_regulators5$Yor)), as.vector(24*prediciton_cla_dl_irna_regulators5$p1)))))
...
prediciton_cla_dl_irna_regulators6$pred <- pmax( round( (prediciton_cla_dl_irna_regulators5$p1*24) - mean(prediciton_cla_dl_irna_regulators5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_irna_regulators3$Yor))-as.vector(24*prediciton_cla_xgboost_irna_regulators3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_irna_regulators3$Yor)), as.vector(24*prediciton_cla_xgboost_irna_regulators3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_xgboost_irna_regulators5$Yor))-as.vector(24*prediciton_cla_xgboost_irna_regulators5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_xgboost_irna_regulators5$Yor)), as.vector(24*prediciton_cla_xgboost_irna_regulators5$p1)))))
...
prediciton_cla_xgboost_irna_regulators6$pred <- pmax( round( (prediciton_cla_xgboost_irna_regulators6$p1*24) - mean(prediciton_cla_xgboost_irna_regulators5$p1*24) + mean_ycount_on_training), 1)
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_irna_regulators3$Yor))-as.vector(24*prediciton_cla_rf_irna_regulators3$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_irna_regulators3$Yor)), as.vector(24*prediciton_cla_rf_irna_regulators3$p1)))))
...
(mse <- mean((as.vector(as.numeric(prediciton_cla_rf_irna_regulators5$Yor))-as.vector(24*prediciton_cla_rf_irna_regulators5$p1))^2))
(ce <-  -1*mean(log(dpois(as.vector(as.numeric(prediciton_cla_rf_irna_regulators5$Yor)), as.vector(24*prediciton_cla_rf_irna_regulators5$p1)))))
...
prediciton_cla_rf_irna_regulators6$pred <- pmax( round( (prediciton_cla_rf_irna_regulators6$p1*24) - mean(prediciton_cla_rf_irna_regulators5$p1*24) + mean_ycount_on_training), 1)
